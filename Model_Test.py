...
data = {
    "Days_for_shipping_real": [3, 5, 4, 3, 2, 6, 2, 2, 3, 2, 6, 5, 4, 2, 2, 2, 5, 2, 0, 0, 5, 4, 3, 2, 6],
    "Days_for_shipment_scheduled": [4, 4, 4, 4, 4, 4, 1, 1, 2, 1, 2, 2, 2, 1, 1, 1, 2, 1, 0, 0, 4, 2, 2, 2, 2],
    "Benefit_per_order": [91.25, -249.09, -247.78, 22.86, 134.21, 18.58, 95.18, 68.43, 133.72, 132.15, 130.58, 45.69, 21.76, 24.58, 16.39, -259.58, -246.36, 23.84, 102.26, 87.18, 154.86, 82.30, 22.37, 17.70, 90.28],
    "Sales_per_customer": [314.64, 311.36, 309.72, 304.81, 298.25, 294.98, 288.42, 285.14, 278.59, 275.31, 272.03, 268.76, 262.20, 245.81, 327.75, 324.47, 321.20, 317.92, 314.64, 311.36, 309.72, 304.81, 298.25, 294.98, 288.42]
}
